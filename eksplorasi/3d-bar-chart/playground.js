...
function loadCsvExample() {
  ...
  document.getElementById("style").value = "bar-color";
  document.getElementById("verticalRatio").value = "0.5";

  document.getElementById("xLabel").value = "time";
  document.getElementById("yLabel").value = "bankID";
  document.getElementById("zLabel").value = "Score";
