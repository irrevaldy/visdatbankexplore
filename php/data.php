<?php
  ...
  /*  $attrib = $_GET['id'];*/
    ...
    $ldrmaxvar = $_GET['ldrmaxvar'];
      ...
      {
            $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";

      }
      elseif($ownership =='All' && $buku == 'All' && $dsib_flag != 'All')
      {
        $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where dsib_flag = '$dsib_flag'and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
      elseif($buku =='All' && $dsib_flag == 'All' && $ownership !='All')
      {
        $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where ownership = '$ownership'and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
      elseif($ownership =='All' && $dsib_flag == 'All' && $buku !='All')
      {
        $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where buku= '$buku' and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
      elseif($ownership =='All' && $buku != 'All' && $dsib_flag != 'All')
      {
        $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where buku = '$buku' and dsib_flag = '$dsib_flag' and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
      elseif($buku =='All' && $dsib_flag != 'All' && $ownership !='All')
      {
        $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where ownership = '$ownership' and dsib_flag = '$dsib_flag' and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
      elseif($dsib_flag == 'All' && $ownership !='All' && $buku != 'All')
      {
        $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where ownership = '$ownership' and buku = '$buku' and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
      elseif($ownership !='All' && $buku != 'All' && $dsib_flag != 'All')
      {
            $myquery = "SELECT id_bank, size, interconnect, complexity, car, npl_rasio, ldr FROM bank where ownership = '$ownership' and buku = '$buku' and dsib_flag = '$dsib_flag'and MONTH(timestamp) = '$month' and YEAR(timestamp) = '$year' and id_data = '$id_data' and car between $carminvar and $carmaxvar and npl_rasio between $nplrasiominvar and $nplrasiomaxvar and assets between $assetsminvar and $assetsmaxvar and kredit between $kreditminvar and $kreditmaxvar and npl_nominal between $nplnominalminvar and $nplnominalmaxvar and deposit between $depositminvar and $depositmaxvar and ldr between $ldrminvar and $ldrmaxvar";
      }
